...
namespace IndieMarc.EnemyVision
{
    ...
    {
        [Header("Linked Enemy")] public EnemyVision target;

        [Header("Vision")] public float vision_angle = 30f;
        ...
        [Header("Material")] public Material cone_material;
        public Material cone_far_material;
        public int sort_order = 1;

        [Header("Optimization")] public int precision = 60;
